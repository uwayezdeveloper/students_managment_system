...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE tbluser SET Name = :adminname, MobileNumber = :mobilenumber, Email = :email WHERE ID = :aid";
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post">
                                        ...
                                        ?>
                                                ...
                                                <div class="form-group">
                                                    <label for="userregdate">Admin Registration Date</label>
                                                    <input type="text" name="userregdate" value="<?php echo $row->UserRegdate; ?>" readonly="" class="form-control">
                                                </div>
                                        <?php }
                                        } ?>
