...
<html lang="en">
<head>
    <title>Student  Information System || Manage Teachers</title>
    <!-- plugins:css -->
                                    ...
                                    <div class="table-responsive border rounded p-1">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                $ret = "SELECT ID FROM tbluser WHERE Role='Teacher'";
                                                ...
                                                $sql = "SELECT * FROM tbluser WHERE Role='Teacher' LIMIT $offset, $no_of_records_per_page";
                                                $query = $dbh->prepare($sql);
                                                $query->execute();
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div><a href="edit-teacher-detail.php?editid=<?php echo htmlentities($row->ID); ?>"><i class="icon-eye"></i></a>
                                                                    || <a href="manage-teachers.php?delid=<?php echo htmlentities($row->ID); ?>" onclick="return confirm('Do you really want to Delete ?');"><i class="icon-trash"></i></a></div>
                                                            </td>
                                                        </tr>
                                                <?php $cnt = $cnt + 1;
                                                    }
